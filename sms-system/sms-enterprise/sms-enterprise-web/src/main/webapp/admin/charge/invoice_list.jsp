    ...
    layui.extend({tableExt: '/js/layui-ext/tableExt'}).use(['tableExt'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'invoice_Title', title: '发票抬头', width: 150}
                , {field: 'invoice_Amount', title: '发票金额', width: 130}
                , {field: 'duty_Daragraph', title: '纳税人识别号', width: 170}
                , {title: '企业信息', templet: function (d) {
