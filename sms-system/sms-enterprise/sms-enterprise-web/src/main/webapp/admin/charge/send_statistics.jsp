...
<div class="layui-fluid" style="padding: 0px">
    <div class="layui-col-md12" style="padding: 0px">
        <div class="layui-card"  style="padding: 0px 0px 30px 0px;">
            <form class="layui-form layui-card-header layuiadmin-card-header-auto" id="sendForm" onsubmit="return loadSendData();">
...
<script type="text/javascript">
    ...
    function loadSendData() {
        ...
        var submitUrl = '/admin/sended_querySubmitListTotalData?';
    ...
    function loadSendTable() {
        layui.use('table', function(){
            ...
            table.render({
                ...
                ,height: 'full-200'
                ,cols: [[ //标题栏
                    {field: 'submitCount', title: '总条数',width: 170}
                    ,{field: 'submitSuccessSmsTotal', title: '提交成功',width: 170}
                    ,{field: 'submitFaildSmsTotal', title: '提交失败',width: 170}
                    ,{field: 'sortFaildSmsTotal', title: '分拣失败',width: 170}
                    ,{field: 'reportCount', title: '回执条数',width: 170}
                    ,{field: 'sendSuccessSmsTotal', title: '发送成功',width: 170}
                    ,{field: 'sendFaildSmsTotal', title: '发送失败',minWidth: 120}
                ]]
                ,data: [{
