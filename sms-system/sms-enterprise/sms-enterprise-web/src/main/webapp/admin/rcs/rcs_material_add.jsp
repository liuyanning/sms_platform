...
<form class="layui-form" action="" id="subForm" onsubmit="return ajaxSubmitForm()"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width:60%;">
            <ht:herocodeselect sortCode="material_type_code" id="material_Type" name="material_Type"/>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label" style="width:20%;">备注</label>
        <div class="layui-input-inline" style="width:60%;">
            <textarea type="text" autocomplete="off" class="layui-textarea"></textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width:60%;">
            ...
            音频格式支持：MP3；<br>
            视频格式支持：MP4、3GP；<br>
            每次上传一个文件，小于<c:out value="${maxRcsMaterialSize}"/>KB
        </div>
    </div>
...
<script >
    ...
    function ajaxSubmitForm() {
        ...
        var maxMaterialSize = '${maxRcsMaterialSize}';
        ...
        $("#subForm").ajaxSubmit({
            type: 'post',
            url: '/admin/business_addRcsMaterialUser',
            dataType: 'json',
            data: data,
            success: function (d) {
