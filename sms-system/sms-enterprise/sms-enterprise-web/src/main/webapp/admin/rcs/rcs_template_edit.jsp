    ...
    <div class="layui-row layui-col-space15">
        <form class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width:80%;">
                    <input type="text" maxlength="128" value="<c:out value="${rcsTemplate.template_Name}"/>" id="template_Name" placeholder="请输入" autocomplete="off" class="layui-input"  lay-verify="required">
                </div>
            </div>
            <div class="layui-form-item">
        ...
        <form class="layui-form" action="" onsubmit="return ajaxSubmitForm()">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width:80%;">
                    <input type="text" maxlength="128" value="<c:out value="${rcsTemplate.description}"/>" id="description"  autocomplete="off" class="layui-input" >
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">备注</label>
                <div class="layui-input-block" style="width:80%;">
                    <textarea type="text" maxlength="128" id="remark" autocomplete="off" class="layui-textarea"><c:out value="${rcsTemplate.remark}"/></textarea>
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    var message_Type = "<c:out value="${rcsTemplate.message_Type}"/>";
    ...
    layui.use(['form', 'carousel'], function () {
        ...
        //解析数据展示
        var template_Content = <c:out value="${rcsTemplate.template_Content}" escapeXml="false"/>;
    ...
    function ajaxSubmitForm() {
        ...
        $.ajax({
            ...
            url: '/admin/business_editRcsTemplate', // 需要提交的 url
            dataType: 'json',
            data: {
                "id":'<c:out value="${rcsTemplate.id}"/>',
