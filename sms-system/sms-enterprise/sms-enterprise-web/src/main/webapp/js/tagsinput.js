...
(function ($) {
  ...
  function TagsInput(element, options) {
    ...
    this.$input = $('<input type="text" placeholder="' + this.placeholderText + '" size="35"/>').appendTo(this.$container);
  ...
  TagsInput.prototype = {
    ...
    add: function(item, dontPushVal, options) {
      ...
      var $tag = $('<span class="badge ' + htmlEncode(tagClass) + (itemTitle !== null ? ('" title="' + itemTitle) : '') + '">' + htmlEncode(itemText)
          + '<span><a href="#" data-role="remove">x</a></span></span>');
      $tag.data('item', item);
