...
<body>
<form class="layui-form" action="/admin/account_bindUserRole" onsubmit="return false;" style="padding: 20px 30px 0 0;">
    <div class="layui-form-item">
        <input type="hidden" name="ckIds" value="<c:out value="${userId}"/>">
        <label class="layui-form-label">角色</label>
        <div class="layui-input-block" id="roles">
            <c:forEach items="${adminRoleExtList}" var="st" varStatus="i">
                <input type="checkbox"
                    <c:out value="${st.adminUser!=null?'checked=true': ''}"/> name="ckRoleId[]" lay-skin="primary"
