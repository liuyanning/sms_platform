        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-body" pad15>
                    ...
                    <form class="layui-form" action="/admin/account_editPassword"  lay-filter="form"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="password" maxlength="12" id="password" name="password" lay-verify="required|password"
                                       lay-verType="tips"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="password" maxlength="12"  name="loginPassword" lay-verify="required|confirmPassword"
...
<%--<%@ include file="/admin/common/layui_bottom.jsp" %>--%>
    ...
    <script type="text/javascript">
        ...
        layui.extend({formExt: '/layuiadmin/extends/formExt'}).use('formExt', function () {
