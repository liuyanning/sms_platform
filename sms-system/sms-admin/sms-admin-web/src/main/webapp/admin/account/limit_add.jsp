...
<body>
<form class="layui-form" action="/admin/account_saveLimit" lay-filter="form" onsubmit="return false;"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" maxlength="1024" name="url_Param" placeholder="请输入Url参数" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="number"  min="0" max="2147483647"  name="order_Id" lay-verify="required" placeholder="请输入显示顺序" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
