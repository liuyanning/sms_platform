...
<body>
<form class="layui-form" action="/admin/product/updateProductChannelsDiversionSignature" onsubmit="return false;"
...
<script type="text/javascript">
	...
	$("#signature").val(strategy_Rule.signature);
	$("#subCode").val(strategy_Rule.subCode);
