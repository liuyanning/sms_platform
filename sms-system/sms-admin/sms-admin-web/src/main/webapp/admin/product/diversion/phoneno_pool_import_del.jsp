...
<body>
<form class="layui-form" id="importFileForm" action="/admin/product/diversionPhoneNoPoolImportDel" lay-filter="form"
    ...
    <input name="strategy_Type_Code" id="strategy_Type_Code" type="hidden" value="phone_no_poll"/>
