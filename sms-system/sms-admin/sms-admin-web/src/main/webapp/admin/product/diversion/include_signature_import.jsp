...
<body>
<form class="layui-form" id="importFileForm" action="/admin/product/importProductChannelsSignature" lay-filter="form"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-form-mid layui-word-aux" >
            ...
            <font color="red">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                每行数据格式为：签名 + <font color="blue">,</font> + 子编码
            </font><br/>
            <font color="red">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                示例：【拼多多】<font color="blue">,</font>301001
            </font><br/>
            <font color="red">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                【京东支付】<font color="blue">,</font>201002
            </font><br/>
            <font color="red">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                支持文件格式:&nbsp;txt
