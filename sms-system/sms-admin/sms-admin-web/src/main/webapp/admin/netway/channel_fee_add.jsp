...
<body>
<form class="layui-form" action="/admin/netway_addChannelFee" lay-filter="form" onsubmit="return false;"
      style="padding: 20px 30px 0 0;">
    <input name="channel_No" id="subChannelNo" lay-verify="required" hidden/>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 60%">
            <input type="number" step="0.0001" min="-99999999.9999" max="99999999.9999"name="unit_Price" required lay-verify="required" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 60%">
            <ht:herocodeselect sortCode="message_type_code" layVerify="required" name="message_Type_Code"/>
        </div>
    </div>
...
<script>
    window.onload = function () {
        var channelNo = $(window.parent.document).find("#channelNo").val();
        $("#subChannelNo").val(channelNo);
    }
