...
<form class="layui-form" action="/admin/enterprise_editEnterpriseUserFee" lay-filter="form" onsubmit="return false;"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 60%">
            <ht:herocodeselect sortCode="country" name="country_Number" id="country_Number" selected="${enterpriseUserFee.country_Number}" valueField="Value" layVerify="required"/>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 60%">
            <ht:countryoperatorselect id="operator" layVerify="required" name="operator"
                                      countryNumber="${enterpriseUserFee.country_Number}"
                                      selected="${enterpriseUserFee.operator}" />
        </div>
    </div>
    <div class="layui-form-item">
