...
<form class="layui-form" action="/admin/enterprise_addSmsTemplateByInput" lay-filter="form" id="dialogFormId"  onsubmit="return false;"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width:300px;">
            <ht:heroenterpriseselect selected="${inputExt.enterprise_No}" layVerify = "required" name="enterprise_No" id="enterprise_No"/>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">企业用户<font color="red">&nbsp;&nbsp;*</font></label>
        <div class="layui-input-inline" style="width:300px;">
            <ht:herocustomdataselect dataSourceType="allEnterpriseUsers"  name="enterprise_User_Id" selected="${inputExt.enterprise_User_Id}"/>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">模板内容<font color="red">&nbsp;&nbsp;*</font></label>
        <div class="layui-input-block">
            <textarea type="text" maxlength="1024" name="template_Content" autocomplete="off" class="layui-textarea" lay-verify="required">${inputExt.content}</textarea>
