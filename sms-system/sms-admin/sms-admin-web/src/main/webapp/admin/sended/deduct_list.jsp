...
<div id="dialogId" hidden>
    <form class="layui-form" lay-filter="form" id="dialogFormId" onsubmit="return false;"
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">回执状态<font color="red">&nbsp;&nbsp;*</font></label>
            <div class="layui-input-inline">
                <ht:herocodeselect sortCode="report_status_code" layVerify = "required" name="report_status_code" id="deduct_status_code" />
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item" style="text-align: left">
            <div style="float: left">
                ...
                <br/>
                <font color="red">共<font id="font2" color="blue"></font>条数据！是否确认批量生成回执？</font>
            </div>
        </div>
    </form>
</div>
...
<script>
    ...
    function sendDeductReport() {
        ...
        var queryButtonUrl = '/admin/sended_queryResendSmsCount?is_Deduct=1&submit_Status_Code=success&';
        //查询要发送扣量回执的数量
        $.ajax({
                ...
                if (res.code == '0') {
                    ...
                    var layerOpen = layer.open({
                        ...
                        yes: function (index, layero) {
                        	var deduct_status_code = $("#deduct_status_code").val();
                            if(!deduct_status_code){
                                layer.msg("请选择扣量手工单状态");
                            	return;
                            }
                            var resendButtonUrl = '/admin/sended_sendDeductReport?';
                            resendButtonUrl += $("#layuiForm").serialize() + "&deductStatusCode=" + deduct_status_code;
                            ...
                            $.ajax({
                                ...
                                success: function (res) {
                                    ...
                                    if (res.code == '0') {
                                        layer.msg('批量生成回执成功', {icon: 1, time: 2000}, function(){});
                                    } else {
                                        layer.msg(res.msg);
                                    }
