    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" maxlength="2048"  name="name" id="poolName" lay-verify="required" placeholder="请输入名称" autocomplete="off"
             ...
             <input name="sort_Code" type="hidden" value="sensitive_word_pool"/>
        </div>
    </div>
    <div class="layui-form-item">
...
function mkLinks(num){
        var str="123456789abcdefghijglmno123pqrstuvwxyz123567zxcvbnmasdfghjklqwertyuiop";
        var res='';
        for(var i=0;i<num;i++){
            res+=str[Math.floor(Math.random()*str.length)];
        }
        return "sensitive_word_pool_"+res;
    }
