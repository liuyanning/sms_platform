...
<form class="layui-form" lay-filter="form" onsubmit="return false;" id="subForm"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <ht:heroenterpriseselect  layVerify = "required" id="enterprise_No"/>
        </div>
        <label class="layui-form-label">企业用户<font color="red">&nbsp;&nbsp;*</font></label>
        <div class="layui-input-inline">
            <select id="enterprise_User_Id" ></select>
        </div>
    </div>
    <div class="layui-form-item">
        <div id="materialDivId">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 65%;">
                    <input maxlength="128" placeholder="彩信标题" id="mmsTitle" class="layui-input" />
                </div>
            </div>
            <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    function selectMaterial() {
        var enterprise_No = $("select[id='enterprise_No']").val();//企业
        if(!enterprise_No){
            return layer.msg("请选择企业！");
        }
        var params = 'enterprise_No='+enterprise_No;
        params += '&approve_Status=1';//审核通过
    ...
    function clickSend() {
        ...
        var enterprise_User_Id = $("select[id='enterprise_User_Id']").val();//用户
