...
<script>
  layui.extend({tableExt: '/layuiadmin/extends/tableExt'}).use(['tableExt'], function () {
    ...
    table.render({
      url: '/admin/business_blackList'
      , cols: [[
        {checkbox: true},
        {field: 'phone_No', title: '手机号码', minWidth: 150, width: 150},
        {
          title: '黑名单类型', minWidth: 150, width: 150, templet: function (d) {
            return handleData(d.pool_Code_name);
          }
        },
        {
          field: 'enterprise_No_ext', title: '企业编号/名称', minWidth: 180, width: 180, templet: function (d) {
            return handleData(d.enterprise_No)
                +"<br>"+ handleData(d.enterprise_No_ext.name);
          }
        },
        {
