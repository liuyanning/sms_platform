...
<body>
<form class="layui-form" id="subForm" action="/admin/business_addInterceptStrategy" onsubmit="return ajaxSubmitForm();"
      style="padding: 20px 30px 0 0;">
    <div class="layui-form-item">
        <label class="layui-form-label">策略名称<font color="red">&nbsp;&nbsp;*</font></label>
        <div class="layui-input-inline">
            <input type="text" maxlength="128" name="name" id="name" lay-verify="required" placeholder="请输入" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <ht:herocodeselect sortCode="faild_type_code" name="faild_Type_Code"/>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <ht:herocodeselect sortCode="external_Black_Pool" name="external_Black_Pool"/>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea type="text" maxlength="128" name="remark" autocomplete="off" class="layui-textarea"></textarea>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function ajaxSubmitForm() {
        ...
        $.ajax({
            ...
            url: '/admin/business_addInterceptStrategy', // 需要提交的 url
            dataType: 'json',
            data: data,
            success: function (d) {
