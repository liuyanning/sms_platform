...
<body>
<form class="layui-form" action="/admin/business_addCode" lay-filter="form" onsubmit="return false;"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea type="text" maxlength="2048" name="value" autocomplete="off" class="layui-textarea"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
