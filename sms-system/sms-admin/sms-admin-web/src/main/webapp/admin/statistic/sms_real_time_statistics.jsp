            ...
            <div class="layui-tab">
                ...
                <div class="layui-tab-content" style="padding: 0px">
                    <div class="layui-tab-item layui-show">
                        <iframe src="/admin/statistic/input_log_statistics.jsp" width="100%" height="100%" frameborder="0"></iframe>
                    </div>
                    <div id="uploadFileSms" class="layui-tab-item" >
                        <iframe src="/admin/statistic/send_statistics.jsp" width="100%" height="100%" frameborder="0"></iframe>
                    </div>
                </div>
            </div>
        </div>
