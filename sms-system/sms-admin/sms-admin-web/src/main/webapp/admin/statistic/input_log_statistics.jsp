...
<div class="layui-fluid" style="padding: 0px">
    <div class="layui-col-md12" style="padding: 0px">
        <div class="layui-card"  style="padding: 0px 0px 30px 0px;">
            <form class="layui-form layui-card-header layuiadmin-card-header-auto" id="inputForm" action="" onsubmit="return loadInputLogData();">
...
<script type="text/javascript">
    ...
    function loadInputLogData() {
        ...
        layui.use('layer', function(){
            ...
            $.ajax({
                type: 'post',
                url: inputLogUrl+'&minCreateDate='+minInputDate+'&maxCreateDate='+maxInputDate+'&'+$("#inputForm").serialize(), // 需要提交的 url
                dataType: 'json',
