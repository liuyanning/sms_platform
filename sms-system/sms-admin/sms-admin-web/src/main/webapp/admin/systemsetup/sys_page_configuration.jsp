...
<script>
    layui.extend({tableExt: '/layuiadmin/extends/tableExt'}).use(['tableExt'], function () {
        ...
        table.render({
            height: 'full-50',
            elem: '#list_table',
            url: '/admin/business_pageConfigurationCodeList',
            url: '/admin/page_configuration/business_codeListBySortCode',
            cols: [[
                {title: '分类', width: 150, templet: function(d){
                        return d.sort_Code_ext?handleData(d.sort_Code_ext.name):'---';
                    }},
                {field: 'sort_Code', title: 'Sort_Code', width: 200},
                {field: 'name', title: '名称', width: 200},
                {field: 'code', title: '代码', width: 350},
                {field: 'value', title: '代码值', minWidth: 200, edit: 'text'}
            ]],page: false
        });
        var $ = layui.$;
        //监听单元格编辑
