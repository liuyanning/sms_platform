...
<form class="layui-form" action="/admin/business_editAlarm" lay-filter="form" onsubmit="return false;"
      style="padding: 20px 30px 0 0;">
    <input type="hidden" name="id" value="<c:out value="${alarm.id}"/>"/>
    <div class="layui-form-item">
        <label class="layui-form-label">告警类型<font color="red">&nbsp;&nbsp;*</font></label>
        <div class="layui-input-inline">
            <ht:herocodeselect sortCode="alarm_type" name="type_Code" selected="${alarm.type_Code}"/>
        </div>
        <label class="layui-form-label">告警间隔<font color="red">&nbsp;&nbsp;*</font></label>
        <div class="layui-input-inline">
            <ht:herocodeselect sortCode="alarm_probe_time" name="probe_Time" id="probe_Time" selected="${alarm.probe_Time}"/>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">告警次数<font color="red">&nbsp;&nbsp;*</font></label>
        <div class="layui-input-inline">
            <ht:herocodeselect sortCode="alarm_total" name="max_Alarm_Total" selected="${alarm.max_Alarm_Total}"/>
        </div>
        <label class="layui-form-label">恢复短信<font color="red">&nbsp;&nbsp;</font></label>
        <div class="layui-input-inline">
            <ht:herocodeselect sortCode="006" name="recovery_Notify" selected="${alarm.recovery_Notify}"/>
        </div>
    </div>
    <div class="layui-form-item" id="threshold_Value">
        ...
        <div class="layui-input-block" style="width:70%">
            <input type="text" maxlength="128" name="threshold_Value" placeholder="根据告警类型输入对应值" autocomplete="off" class="layui-input"
                   value="<c:out value="${alarm.threshold_Value}"/>"
                   lay-verify="required">
    ...
    <div class="layui-form-item" id="monitorTime">
    ...
    <div class="layui-form-item">
        ...
        <div id="bindAccountDiv"style="display: none">
            <div class="layui-input-inline" style="width:70%">
                <ht:herocustomdataselect dataSourceType="allEnterpriseUsers" name="bind_Value_User_Id" selected="${alarm.bind_Value_User_Id}"/>
            </div>
        </div>
        <div id="bindAgentDiv" style="display: none">
            <div class="layui-input-inline" style="width:70%">
                <ht:herocustomdataselect dataSourceType="allAgent" name="bind_Value_Agent_No" selected="${alarm.bind_Value_Agent_No}"/>
            </div>
        </div>
        <div id="bindChannelDiv" style="display: none">
            <div class="layui-input-inline" style="width:70%">
                <ht:herocustomdataselect dataSourceType="allChannels" name="bind_Value_Channel_No" selected="${alarm.bind_Value_Channel_No}"/>
            </div>
        </div>
        <div id="bindProductDiv" style="display: none">
            <div class="layui-input-inline" style="width:70%">
                <ht:herocustomdataselect dataSourceType="allProducts" name="bind_Value_Product_No" selected="${alarm.bind_Value_Product_No}"/>
            </div>
        </div>
        <div id="bindInputDiv" style="display: none">
            <div class="layui-input-inline" style="width:70%">
                <ht:herocustomdataselect dataSourceType="allAdmin" name="bind_Value_Input_Id" selected="${alarm.bind_Value_Input_Id}"/>
            </div>
        </div>
        <div id="bindServerDiv">
            <div class="layui-input-inline" style="width: 70%;">
                <textarea maxlength="128" placeholder="请输入服务器ip地址" class="layui-textarea" name="bind_Value_Server_Ip">${alarm.bind_Value_Server_Ip}</textarea>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 70%;">
            <textarea maxlength="128" placeholder="请输入手机号码" class="layui-textarea" name="phone_Nos">${alarm.phone_Nos}</textarea>
            <div class="layui-word-aux" style="width:70%">
                (多个号码逗号分割,最多10个号码)
            </div>
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 70%;">
            <textarea maxlength="128" placeholder="请输入邮箱地址" class="layui-textarea" name="emails">${alarm.emails}</textarea>
            <div class="layui-word-aux" style="width:70%">
                (多个邮箱地址逗号分割,最多8个邮箱地址)
            </div>
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <ht:herocodeselect sortCode="wechat_party" name="wechat" selected="${alarm.wechat}"/>
        </div>
        <label class="layui-form-label">钉钉</label>
        <div class="layui-input-inline">
            <ht:herocodeselect sortCode="ding_talk_party" name="ding_Talk" selected="${alarm.ding_Talk}"/>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">描述</label>
        <div class="layui-input-block" style="width: 70%;">
            <textarea type="text" maxlength="512" name="description" autocomplete="off" class="layui-textarea">${alarm.description}</textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">备注</label>
        <div class="layui-input-block" style="width: 70%;">
            <textarea type="text" maxlength="512" name="remark" autocomplete="off" class="layui-textarea">${alarm.remark}</textarea>
        </div>
    </div>
        ...
        form.on('select(onselect)', function (data) {
            ...
            if(type_Code){
                ...
                if("channel" == splits[0]){//通道
                    ...
                    $("select[name='bind_Value_User_Id']").val('');
                    $("select[name='bind_Value_Channel_No']").val('');
            	}else if("sort" == splits[0]){//队列
                    $("select[name='bind_Value_Channel_No']").val('');
                }else if("submit" == splits[0]){//队列
                    $("select[name='bind_Value_Channel_No']").val('');
                }else if("user" == splits[0]){//用户未提交数据预警
                    $("#bindAccountDiv").attr("style","display:block;");//显示div
                    $("#monitorTime").attr("style","display:block;");//显示div
