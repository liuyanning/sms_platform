...
public class ExcelExportTest {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < count; i++) {
			...
			s.setName("POI-测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试");
			s.setAge(i);
		...
		File file = new File("E://ExcelExportDemo/");
