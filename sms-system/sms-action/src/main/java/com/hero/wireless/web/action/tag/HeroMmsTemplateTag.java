...
public class HeroMmsTemplateTag extends TagSupport{
    ...
    public int doEndTag() throws JspException {
        ...
        if(StringUtils.isNotEmpty(enterpriseNo) && enterpriseUserId != null){
            List<? extends MmsTemplate> mmsTemplateList = DatabaseCache.
                    getMmsTemplateList(enterpriseNo,enterpriseUserId,AuditStatus.PASS.value());
            if(mmsTemplateList != null && !mmsTemplateList.isEmpty()){
                mmsTemplateList.forEach(item ->{
                    htmlBuffer.append("<option value=\"");
                    htmlBuffer.append(item.getTemplate_Code());
                    htmlBuffer.append("\" ");
