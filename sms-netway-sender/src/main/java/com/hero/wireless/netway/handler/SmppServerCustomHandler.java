 ...
 **/
public class SmppServerCustomHandler extends AbstractServerCustomHandler {

    @Override
    public void configPipelineAfterLogin(ChannelPipeline pipeline) {
        pipeline.addLast("SmppServerBusinessHandler", GlobalHandler.SMPP_SERVER_BUSINESS_HANDLER);
    }

    @Override
    protected ProtocolType getProtocolType() {
        return ProtocolType.SMPP;
    }
}
