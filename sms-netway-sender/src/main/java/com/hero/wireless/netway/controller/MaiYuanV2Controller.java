 ...
 */
@Controller
public class MaiYuanV2Controller extends BaseService {
    @Autowired
     ...
     * @return
     */
    @RequestMapping("/v2statusApi.aspx")
    @ResponseBody
    ...
    public static void main(String[] args) {
        System.out.println(SecretUtil.MD5("enterprise001" + "admin" + "20200318150608534" + "4297F44B13955235245B2497399D7A93"));
    }
}
